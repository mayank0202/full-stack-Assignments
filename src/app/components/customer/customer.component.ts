...
export class CustomerComponent implements OnInit {
  customerData!:any;
  constructor(private formbuilder:FormBuilder,private router:Router,private api:ApiService,private user :ActivatedRoute) { }
  ...
  createCustomer(){
    ...
    this.api.createCustomer(this.customerModel)
    .subscribe(res=>{
      console.log(res);
  ...
  updateCustomer(){
    ...
    this.customerModel.website = this.formValue.value.website;
    this.customerModel.address = this.formValue.value.address;
    this.api.updateCustomer(this.customerModel,this.customerModel.id)
    .subscribe(res=>{
      alert("data saved successfully");
      console.log(res);
      let closeform = document.getElementById('cancel')
