...
router.patch('/:id',(req,res)=>{
    ...
    myData[data]["First_Name"]=user.First_Name;
    myData[data]["Middle_Name"]=user.Middle_Name;
    myData[data]["Last_Name"]=user.Last_Name;
    myData[data]["Email"]=user.Email;
    myData[data]["Phone_Number"]=user.Phone_Number;
